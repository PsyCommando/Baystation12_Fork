...
/datum/persistence/query_builder/proc/AddThing(var/type)
	...
	//Q.Add("INSERT INTO `thing` (`id`,`type`,`version`) VALUES(?,?);", thing_index, type, version)
	return thing_index
...
/datum/persistence/query_builder/proc/AddThingVar(var/thing_id, var/type, var/name, var/value)
	...
	//Q.Add("INSERT INTO `thing_var` (`id`, thing_id,`type`,`name`,`value`,`version`) VALUES(?,?,?,?,?,?)", thing_var_index, thing_id, type, name, value, version)
...
/datum/persistence/query_builder/proc/AddThingListVar(var/thing_id, var/type, var/value)
	...
	//Q.Add("INSERT INTO `thing_list_var` (`id`, thing_id, `type`, `value`, `version`) VALUES(?,?,?,?,?)", thing_list_var_index, thing_id, type, value, version)
...
/datum/persistence/query_builder/proc/AddArea(var/name)
	...
	//Q.Add("INSERT INTO `area` (`id`,`name`,`version`) VALUES(?,?,?)", area_index, name, version)
	return area_index
...
/datum/persistence/query_builder/proc/AddAreaTurf(var/area_id, var/thing_id, var/pixel_x, var/pixel_y, var/z_layer)
	...
	//Q.Add("INSERT INTO `area_turf (`area_id`,`thing_id`,`pixel_x`,`pixel_y`,`z_layer`,`version`) VALUES(?,?,?,?,?,?)", area_id, thing_id, pixel_x, pixel_y, z_layer, version)
